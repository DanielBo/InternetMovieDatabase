							...
							table.addMouseListener(new MouseListener() {
								...
								public void mouseClicked(MouseEvent e) {
									if (e.getClickCount() >= 2){
										...
										//TODO build Necessary Information for DetailView and open the View for it
...
//							TableColumn column0afterRemove = table.getColumnModel().getColumn(0);
		...
		mainWindow.getModeSelector().addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent e) {
				...
				switch (selectedMode){
					case 0:
						choice = new String[]{"CompanyName", "CompanyType", "TitelType", "PersonenName", "RollenName", "RollenType", "ProductionYear"};
						break;
					case 1:
						choice = new String[]{"Titel", "TitelType", "CompanyType", "PersonenName", "RollenName", "RollenType", "ProductionYear"};
						break;
					case 2:
						choice = new String[]{"Titel", "TitelType", "CompanyName", "CompanyType", "RollenName", "RollenType", "ProductionYear"};
						break;
					default:
