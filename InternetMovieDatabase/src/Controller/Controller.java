...
public class Controller {
	...
	private void connectActions(){
		...
		// ActionListener fï¿½r das Hinzufï¿½gen von Constraints des Typ 1
		mainWindow.getBtnAddConstraint1().addActionListener(new ActionListener(){
			public void actionPerformed(ActionEvent actionEvent) {
				Constraint constraint = null;

				/* Entweder wird an eine bestehendes Constraint mit oder ein weiteres angehï¿½ngt ODER 
				 * Es wird ein einzelnes Constraint erzeugt, dass spï¿½ter per "AND" mit weiteren Constraints verbunden wird.
				 */
				if(mainWindow.getConstraint1AndOr().getSelectedIndex() == 1 && lastConstraintType1 != null){
					...
					// Letztes Constraint wird gelï¿½scht und weiter unten durch das Neue ersetzt.
		...
		// ActionListener fï¿½r das Hinzufï¿½gen von Constraints des Typ 2
